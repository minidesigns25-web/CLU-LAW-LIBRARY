    ...
    >
      ...
      <div className="relative container mx-auto px-4 lg:px-8 text-center">
        ...
        <div className="flex justify-center items-center space-x-4">
          <button className="bg-brand-gold hover:bg-yellow-600 text-white font-bold py-3 px-6 rounded-lg transition-transform duration-300 ease-in-out transform hover:scale-105 flex items-center space-x-2">
            <SearchIcon className="w-5 h-5" />
            <span>Explore Resources</span>
          </button>
          <button className="bg-transparent border-2 border-white hover:bg-white hover:text-brand-purple-dark text-white font-bold py-3 px-6 rounded-lg transition-colors duration-300 ease-in-out flex items-center space-x-2">
